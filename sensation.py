...
from utils.analyze import find_dominant_column
from utils.visualize import visualize_dominant_column


def process_images(ih: InputHandler, segmentator: Segmentator):
